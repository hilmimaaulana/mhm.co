...
<head>
    ...
    <title>Vans Authentic - mhm.co</title>
...
<body>
    ...
    <div class="hero-banner-wrap fade-up delay-2">
        <img src="{{ asset('img/vansauthenticbanner.webp') }}" alt="Vans Authentic Hero">
        <div class="hero-banner-overlay"></div>
        <div class="hero-banner-text">
            <h1 class="hero-banner-title">VANS AUTHENTIC<span> SERIES</span></h1>
            <p class="hero-banner-sub">mhm.co / vans<br>authentic collection</p>
        </div>
    </div>
    ...
    <main class="max-w-[1400px] mx-auto px-10">
        ...
        <div class="page-title-wrap reveal">
            <h2 class="page-title">Vans Authentic <span>Series</span></h2>
            @if($products->count() > 0)
    ...
    <footer>
        ...
        <div class="footer-bottom">
            ...
            <span class="footer-copy">vans authentic series</span>
        </div>
    </footer>
