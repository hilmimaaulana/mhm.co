...
<head>
    ...
    <title>Thrasher T-Shirts - mhm.co</title>
...
<body>
    ...
    <div class="hero-banner-wrap fade-up delay-2">
        <img src="{{ asset('img/thrasherbanner4.jpg') }}" alt="Thrasher Apparel Hero">
        <div class="hero-banner-overlay"></div>
        <div class="hero-red-streak"></div>
        <div class="hero-banner-text">
            <h1 class="hero-banner-title">t-shirts<br><span>Series</span></h1>
            <p class="hero-banner-sub">mhm.co / thrasher<br>t-shirts series</p>
        </div>
    </div>
    ...
    <main class="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-10 mb-12 sm:mb-20">
        ...
        <div class="page-title-wrap reveal">
            <h2 class="page-title">Thrasher <span>T-Shirts</span></h2>
            @if($thrasherTshirt->count() > 0)
                <span class="product-count">{{ $thrasherTshirt->count() }} item{{ $thrasherTshirt->count() > 1 ? 's' : '' }}</span>
            @endif
        </div>
        ...
        @if($thrasherTshirt->count() > 0)
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-x-4 sm:gap-x-5 gap-y-8 sm:gap-y-10">
                @foreach($thrasherTshirt as $product)
                <a href="{{ route('product.show', $product->id) }}" class="product-card stagger-item">
                    <div class="product-img-box">
                        ...
                        <span class="read-chip">Quick View</span>
                    </div>
        ...
        @else
            <div class="empty-wrap">
                <p>t-shirt collection is currently out of stock.</p>
            </div>
        @endif
    ...
    <footer>
        <div class="footer-inner">
            <div>
                ...
                <p class="footer-tagline">MHM x THRASHER</p>
                <p class="footer-desc">Original Thrasher Magazine Apparel. Flame Logo, Skate Goat, and Atlantic Drift Series.</p>
        ...
        <div class="footer-bottom">
            ...
            <span class="footer-copy">thrasher t-shirts</span>
        </div>
    </footer>
