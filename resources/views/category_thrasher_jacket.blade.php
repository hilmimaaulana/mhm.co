...
<head>
    ...
    <title>Thrasher Jackets & Hoodies - mhm.co</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .product-price {
            font-family: 'DM Mono', monospace; font-size: 10px;
            color: var(--black); margin-top: 5px; font-weight: 600;
...
<body>
    ...
    <div class="hero-banner-wrap fade-up delay-2">
        <img src="{{ asset('img/thrasher_jacket_hero.jpg') }}" alt="Thrasher Outerwear Hero">
        <div class="hero-banner-overlay"></div>
        <div class="hero-red-streak"></div>
        <div class="hero-banner-text">
            <h1 class="hero-banner-title">SKATE &amp; <span>DESTROY</span></h1>
            <p class="hero-banner-sub">mhm.co / thrasher<br>premium outerwear</p>
        </div>
    </div>
    ...
    <main class="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-10 mb-12 sm:mb-20">
        ...
        <div class="page-title-wrap reveal">
            <h2 class="page-title">Thrasher <span>Jackets</span></h2>
            @if($thrasherHoodie->count() > 0)
                <span class="product-count">{{ $thrasherHoodie->count() }} item{{ $thrasherHoodie->count() > 1 ? 's' : '' }}</span>
            @endif
        </div>
        ...
        @if($thrasherHoodie->count() > 0)
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-x-4 sm:gap-x-5 gap-y-8 sm:gap-y-10">
                @foreach($thrasherHoodie as $product)
                <a href="{{ route('product.show', $product->id) }}" class="product-card stagger-item">
                    <div class="product-img-box">
                        ...
                        <span class="read-chip">View Details</span>
                    </div>
        ...
        @else
            <div class="empty-wrap">
                <p>jacket & hoodie collection is currently out of stock.</p>
            </div>
        @endif
    ...
    <footer>
        <div class="footer-inner">
            <div>
                ...
                <p class="footer-tagline">mhm.co / thrasher</p>
                <p class="footer-desc">Authentic Thrasher Magazine Heavyweight Hoodies and Jackets. Built for the streets.</p>
                ...
                <a href="https://wa.me/{{ $wa_number }}" target="_blank" class="footer-contact">stockist support →</a>
            </div>
        ...
        <div class="footer-bottom">
            ...
            <span class="footer-copy">thrasher jackets</span>
        </div>
    </footer>
