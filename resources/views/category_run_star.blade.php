...
<head>
    ...
    <title>Run Star Series - mhm.co</title>
...
@php
    // GANTI INFO SOSIAL MEDIA DI SINI GES
    $ig_username = "mhm.co";
    $tg_username = "mhm_co";
    $tt_username = "mhm.co";
...
<body>
    ...
    <div class="hero-banner-wrap fade-up delay-2">
        <img src="{{ asset('img/converserunstarbanner1.webp') }}" alt="Run Star Hero">
        <div class="hero-banner-overlay"></div>
        <div class="hero-banner-text">
            <h1 class="hero-banner-title">Run Star<br><span>Series</span></h1>
            <p class="hero-banner-sub">mhm.co / converse<br>run star series</p>
        </div>
    </div>
    ...
    <main class="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-10 mb-12 sm:mb-20">
        ...
        <div class="page-title-wrap reveal">
            <h2 class="page-title">Run <span>Star</span></h2>
            @if($runStar->count() > 0)
                <span class="product-count">{{ $runStar->count() }} item{{ $runStar->count() > 1 ? 's' : '' }}</span>
            @endif
        </div>
        ...
        @else
            <div class="empty-wrap">
                <p>no run star items found in vault.</p>
            </div>
        @endif
    ...
    <footer>
        ...
        <div class="footer-bottom">
            ...
            <span class="footer-copy">run star series</span>
        </div>
    </footer>
