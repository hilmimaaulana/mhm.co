...
<body>
            ...
            <div class="flex justify-center fade-up delay-3">
                <form action="{{ route('search') }}" method="GET" class="search-wrap">
                    ...
                    <input
                        ...
                        name="search"
                        type="text"
                        placeholder="search skate series..."
                        class="search-input"
                    >
                </form>
            </div>
    ...
    <div class="hero-banner-wrap fade-up delay-2">
        <img src="{{ asset('img/vansskatebanner.webp') }}" alt="Vans Skate Hero">
        <div class="hero-banner-overlay"></div>
        <div class="hero-banner-text">
            <h1 class="hero-banner-title">VANS SKATE<span> SERIES</span></h1>
            <p class="hero-banner-sub">mhm.co / vans<br>skate collection</p>
        </div>
    </div>
    ...
    <main class="max-w-[1400px] mx-auto px-10">
        ...
        <div class="page-title-wrap reveal">
            <h2 class="page-title">Vans Skate <span>Series</span></h2>
            @if($products->count() > 0)
        ...
        @else
            <div class="empty-wrap">
                <p>no skate items found in vault.</p>
            </div>
        @endif
    ...
    <footer>
        <div class="footer-inner">
            <div>
                ...
                <div class="footer-social flex">
                    ...
                    <a href="{{ $links['telegram'] }}" target="_blank" aria-label="Telegram">
                    ...
                    <a href="{{ $links['tiktok'] }}" target="_blank" aria-label="TikTok">
        ...
        <div class="footer-bottom">
            ...
            <span class="footer-copy">vans skate series</span>
        </div>
    </footer>
