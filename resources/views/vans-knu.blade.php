...
<body>
    ...
    <div class="hero-banner-wrap fade-up delay-2">
        <img src="{{ asset('img/vansknubanner1.webp') }}" alt="Vans Knu Hero">
        <div class="hero-banner-overlay"></div>
        <div class="hero-banner-text">
            <h1 class="hero-banner-title">VANS KNU<span> SERIES</span></h1>
            <p class="hero-banner-sub">mhm.co / vans<br>knu collection</p>
        </div>
    </div>
    ...
    <main class="max-w-[1400px] mx-auto px-10">
        ...
        <div class="page-title-wrap reveal">
            <h2 class="page-title">Vans Knu <span>Series</span></h2>
            @if($products->count() > 0)
        ...
        @else
            <div class="empty-wrap">
                <p>no knu items found in database.</p>
            </div>
        @endif
    ...
    <footer>
        <div class="footer-inner">
            <div>
                ...
                <div class="footer-social flex">
                    ...
                    <a href="{{ $socials['telegram'] }}" target="_blank" aria-label="Telegram">
        ...
        <div class="footer-bottom">
            ...
            <span class="footer-copy">vans knu series</span>
        </div>
    </footer>
