...
<head>
    ...
    <title>Chuck Taylor All Star - mhm.co</title>
...
<body>
    ...
    <div class="hero-banner-wrap fade-up delay-2">
        <img src="{{ asset('img/allstar2.jpg') }}" alt="Chuck Taylor Hero">
        <div class="hero-banner-overlay"></div>
        <div class="hero-banner-text">
            <h1 class="hero-banner-title">Chuck Taylor<br><span>All Star</span></h1>
            <p class="hero-banner-sub">mhm.co / converse<br>chuck taylor series</p>
        </div>
    </div>
    ...
    <main class="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-10 mb-12 sm:mb-20">
        ...
        <div class="page-title-wrap reveal">
            <h2 class="page-title">Chuck Taylor <span>All Star</span></h2>
            @if($chuckTaylor->count() > 0)
                <span class="product-count">{{ $chuckTaylor->count() }} item{{ $chuckTaylor->count() > 1 ? 's' : '' }}</span>
            @endif
        </div>
        ...
        @if($chuckTaylor->count() > 0)
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-x-4 sm:gap-x-5 gap-y-8 sm:gap-y-10 mb-16 sm:mb-28">
                @foreach($chuckTaylor as $i => $product)
    ...
    <footer>
        ...
        <div class="footer-bottom">
            ...
            <span class="footer-copy">chuck taylor all star</span>
        </div>
    </footer>
