...
<head>
    ...
    <title>One Star Series - mhm.co</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .auth-greeting {
            ...
            letter-spacing: 0.03em; color: #888; font-style: italic;
        }
        ...
        .hero-banner-wrap {
            ...
            margin-bottom: 0; background: var(--black);
        }
        ...
        .hero-banner-title span { color: rgba(255,255,255,0.28); }
        .hero-banner-sub {
            font-family: 'DM Mono', monospace;
        ...
        .page-title-wrap {
            ...
            border-bottom: 1px solid #ebebeb; margin-bottom: clamp(28px, 4vw, 48px);
        ...
        .product-img-box img {
            ...
            padding: clamp(16px, 3vw, 28px); mix-blend-mode: multiply;
        ...
        .product-card:hover .view-chip { opacity: 1; transform: translateX(-50%) translateY(0); }
        ...
        .product-name {
            ...
            line-height: 1.5; color: #555; margin-top: 10px;
            letter-spacing: 0.01em;
            transition: text-decoration 0.15s;
        }
        .product-card:hover .product-name { text-decoration: underline; text-underline-offset: 2px; }
        .product-price {
            font-family: 'DM Mono', monospace; font-size: 11px;
        ...
        .footer-site-link {
            ...
            display: block; margin-top: 18px; transition: color 0.2s;
        }
...
@php
    // KONTROL PANEL SOSMED - Ganti di sini aja Ges!
    $ig_username = "mhm.co";
    $tg_username = "mhm_co";
    $tt_username = "mhm.co";
...
<body>
        ...
        <div class="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-10">
            <div class="grid grid-cols-3 items-center mb-3 sm:mb-4">
                ...
                <div class="flex justify-start fade-up delay-1">
                    <a href="{{ route('category.converse') }}" class="back-link">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-4 h-4">
                ...
                <div class="flex justify-end items-center gap-3 sm:gap-4 fade-up delay-2">
                    @auth
                        <a href="/profile" class="auth-link">
                            <span class="auth-greeting">{{ Auth::user()->name }}</span>
                    ...
                    @else
                        <a href="/login" class="auth-link">
                            <span class="hidden sm:inline auth-greeting">masuk</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                            </svg>
                        </a>
    ...
    <div class="hero-banner-wrap fade-up delay-2">
        <img src="{{ asset('img/converseonestarbanner1.webp') }}" alt="One Star Hero">
        <div class="hero-banner-overlay"></div>
        <div class="hero-banner-text">
            <h1 class="hero-banner-title">One Star<br><span>Archive</span></h1>
            <p class="hero-banner-sub">mhm.co / converse<br>one star archive</p>
        </div>
    </div>
    ...
    <main class="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-10 mb-12 sm:mb-20">
        ...
        <div class="page-title-wrap reveal">
            <h2 class="page-title">one<span>Star</span></h2>
            @if($oneStar->count() > 0)
                <span class="product-count">{{ $oneStar->count() }} item{{ $oneStar->count() > 1 ? 's' : '' }}</span>
            @endif
        </div>

        <!-- PRODUCT GRID -->
        @if($oneStar->count() > 0)
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-x-4 sm:gap-x-5 gap-y-8 sm:gap-y-10 mb-16 sm:mb-28">
                @foreach($oneStar as $i => $product)
                <a href="{{ route('product.show', $product->id) }}" class="product-card stagger-item">
                    <div class="product-img-box">
                        ...
                        <span class="view-chip">View Details</span>
                    </div>
        ...
        @else
            <div class="empty-wrap">
                <p>one star collection is currently empty.</p>
            </div>
        @endif
    ...
    <footer>
        <div class="footer-inner">
            <div>
                ...
                <p class="footer-desc">official stockist of one star archive series. contact us via social media for sizing and availability.</p>

                @php
                    $sosmed = [
                        'instagram' => 'https://www.instagram.com/hilmimaaulana',
                        'telegram'  => 'https://www.tiktok.com/@hhhhhh.232323',
                ...
                <a href="https://wa.me/{{ $wa_number }}" target="_blank" class="footer-contact">contact admin? →</a>
            </div>
        ...
        <div class="footer-bottom">
            ...
            <span class="footer-copy">one star series</span>
        </div>
    </footer>
