...
<body>
    ...
    <div class="hero-banner-wrap fade-up delay-2">
        <img src="{{ asset('img/vanserabanner1.webp') }}" alt="Vans Era Hero">
        <div class="hero-banner-overlay"></div>
        <div class="hero-banner-text">
            <h1 class="hero-banner-title">VANS ERA<span> SERIES</span></h1>
            <p class="hero-banner-sub">mhm.co / vans<br>era collection</p>
        </div>
    </div>
    ...
    <main class="max-w-[1400px] mx-auto px-10">
        ...
        <div class="page-title-wrap reveal">
            <h2 class="page-title">Vans Era <span>Series</span></h2>
            @if($products->count() > 0)
        ...
        @else
            <div class="empty-wrap">
                <p>no era items found in vault.</p>
            </div>
        @endif
    ...
    <footer>
        ...
        <div class="footer-bottom">
            ...
            <span class="footer-copy">vans era series</span>
        </div>
    </footer>
