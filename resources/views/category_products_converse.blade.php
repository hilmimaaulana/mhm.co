...
<head>
    ...
    <title>Converse Collection - mhm.co</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .hero-cat-bg { position: absolute; inset: 0; background: linear-gradient(110deg, #0a0a0a 40%, #1a1510 100%); }
        .hero-cat-title {
            position: relative; z-index: 2;
            font-family: 'Bebas Neue', sans-serif;
            font-size: clamp(72px, 13vw, 160px);
            letter-spacing: 0.06em; color: rgba(255,255,255,0.06);
        ...
        .banner-wrap:hover .banner-center-overlay { background: rgba(0,0,0,0.14); }
        .banner-center-subtitle {
            font-family: 'DM Mono', monospace; font-size: 10px;
            letter-spacing: 0.4em; color: rgba(255,255,255,0.75);
        ...
        .section-dot { width: 5px; height: 5px; border-radius: 50%; background: var(--black); flex-shrink: 0; }
        ...
        .view-all-link:hover { opacity: 0.45; }
        ...
        .product-card:hover .quick-chip { opacity: 1; transform: translateY(0); }
...
<body>
        ...
        <div class="max-w-[1400px] mx-auto px-10">
            <div class="grid grid-cols-3 items-center mb-6">
                ...
                <nav class="flex justify-center gap-8">
                    ...
                    <a href="{{ route('category.converse') }}" class="nav-active fade-up delay-2">converse</a>
                    <a href="{{ route('category.thrasher') }}" class="nav-link fade-up delay-3">thrasher</a>
            ...
            <div class="flex justify-center fade-up delay-5">
                <form action="/search" method="GET" class="search-wrap">
                    ...
                    <input
                        ...
                        placeholder="search in mhm.co (e.g. converse, chuck taylor...)"
                        class="search-input"
                    >
                </form>
            </div>
    ...
    <div style="overflow:hidden;background:var(--black);padding:10px 0">
        <div class="marquee-track">
            <span>CHUCK TAYLOR ALL STAR</span><span class="dot">·</span>
            <span>ONE STAR SERIES</span><span class="dot">·</span>
            <span>RUN STAR SERIES</span><span class="dot">·</span>
            <span>CONVERSE ALL COLLECTION</span><span class="dot">·</span>
            <span>CHUCK TAYLOR ALL STAR</span><span class="dot">·</span>
            <span>ONE STAR SERIES</span><span class="dot">·</span>
            <span>RUN STAR SERIES</span><span class="dot">·</span>
            <span>CONVERSE ALL COLLECTION</span><span class="dot">·</span>
    ...
    <div class="hero-cat fade-up delay-2">
        ...
        <div class="hero-cat-title">CONVERSE</div>
        <div class="hero-cat-label">
            <h1>CONVERSE</h1>
            <p>since 1908 — chuck taylor &amp; beyond</p>
        </div>
        ...
        @php
            $sections = [
                [
                    ...
                    'data' => $chuckTaylor,
                    'route' => 'category.converse.chucktaylor',
                    'banner_type' => 'split',
                    'banner_img_1' => 'conversebanner1.webp',
                    'banner_img_2' => 'allstar.jpg',
                    'subtitle' => 'The Timeless Icon'
                ],
                [
                    'title' => 'run star series',
                    'data' => $runStar ?? collect(),
                    'route' => 'category.converse.runstar',
                    'banner_type' => 'full',
                    'banner_img_1' => 'runstar.jpg',
                    'subtitle' => 'Elevated Boldness'
                ],
                [
                    'title' => 'one star series',
                    'data' => $oneStar,
                    'route' => 'category.converse.onestar',
                    'banner_type' => 'full',
                    'banner_img_1' => 'onestar1.webp',
                    'subtitle' => 'Effortless Street Style'
                ]
            ];
        @endphp
        ...
        @foreach($sections as $index => $section)
            ...
            <div class="reveal" style="margin-bottom:48px">
                @if($section['banner_type'] == 'split')
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-[6px]">
                        <div class="banner-wrap" style="height:460px">
                ...
                @else
                    <div class="banner-wrap" style="height:420px">
                        <img src="{{ asset('img/' . $section['banner_img_1']) }}" class="banner-img" alt="">
            ...
            <section style="margin-bottom:80px">
                <div class="section-head reveal">
                    @php
                        if ($section['title'] == 'run star series') {
                            $targetRoute = route('category.converse.runstar');
                        } else {
                            $targetRoute = route($section['route']);
                        }
                    @endphp
                    <a href="{{ $targetRoute }}" class="section-title-link">
                    ...
                    <a href="{{ $targetRoute }}" class="view-all-link">View All</a>
                </div>
    ...
    <footer>
        ...
        <div class="footer-bottom">
            ...
            <span class="footer-copy">converse collection</span>
        </div>
    </footer>
